...
# add a line to remove additional header lines, 
# introduced from merging ld.gz outputs
d <- subset(d, CHR_A!="CHR_A")
# cast numeric factors
d$BP_A <- as.numeric(d$BP_A)
d$BP_B <- as.numeric(d$BP_B)
d$R2 <- as.numeric(d$R2)
